...
export default class StudentList extends React.Component {
  ...
  renderItem = ({item}) => {
      return(
          <View style={styles.listStyle}>
              <TouchableWithoutFeedback onPress={ () => Alert.alert(item.Email)}>
                  <Text style={styles.row}>
                      {item.First} {item.Last} {item.Standing}
  ...
  componentDidMount(){
      ...
      const url = 'http://cs-ithaca.eastus.cloudapp.azure.com/~ljackson1/comp306Final/student.php'
